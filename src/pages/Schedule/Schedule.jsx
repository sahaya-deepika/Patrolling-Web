...
// // import { useState, useEffect, useRef, useMemo } from 'react'
// // import { useNavigate, useLocation } from 'react-router-dom'
// // import { Panel, Loader, Tag, Progress, Avatar, Button, IconButton } from 'rsuite'
// // import ExitIcon from '@rsuite/icons/Exit'
...
// //   const headerContent = (
// //     <div className="sched-header-title">Scheduled List</div>
// //   )
...
// //       <div className="sched-body">
// //         <Panel className="sched-left-panel" header={headerContent}>
// //           {/* Tabs */}
// //           <div className="sched-tabs">
// //             {TABS.map(t => (
// //               <button key={t} className={`sched-tab${tab===t?' active':''}`} onClick={() => setTab(t)}>{t}</button>
...
// //                       size="sm"
// //                       className="open-btn"
// //                       onClick={e => { e.stopPropagation(); navigate(`/schedule/trip/${row.tripId}`) }} 
